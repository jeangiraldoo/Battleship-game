...
public class Ship {
    ...
    public void paintVertical(GraphicsContext gc) {
        ...
        gc.fillPolygon(
                new double[]{drawPosition.x + 30 / 2, boatLeftX, boatLeftX + boatWidth},
                new double[]{drawPosition.y + 30 / 4, drawPosition.y + 30, drawPosition.y + 30},
                3
        );

        // Dibujar el rectángulo
        gc.fillRect(boatLeftX, drawPosition.y + 30, boatWidth,
                30 * (segments - 1.2));
    }
    ...
    public void paintHorizontal(GraphicsContext gc) {
        ...
        gc.fillPolygon(
                new double[]{drawPosition.x + 30 / 4, drawPosition.x + 30, drawPosition.x + 30},
                new double[]{drawPosition.y + 30 / 2, boatTopY, boatTopY + boatWidth},
                3
        );

        // dibuja el rectangulo
        gc.fillRect(drawPosition.x + 30, boatTopY,
                30 * (segments - 1.2), boatWidth);
    }
}
